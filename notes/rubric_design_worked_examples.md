...
## Where to find the per-retriever scoreboards

This doc covers **rubric design and judge calibration**. The per-retriever HR / Precision scoreboards (Tier 1 n=100 and Tier 2 n=3,185) live in their own headline doc:
